#include "Room_9x9_04.h"

Room_9x9_04::Room_9x9_04(sf::Vector2i position, bool blockRandSpawn, bool playerRoom)
{
    roomDataLocation_ = "./Resources/Map/Room/Factory_Room_9x9_04.csv";
    position_ = position;
    roomWidth_ = 9;
    roomHeight_ = 9;
