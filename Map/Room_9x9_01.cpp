#include "Room_9x9_01.h"

Room_9x9_01::Room_9x9_01(sf::Vector2i position, bool blockRandSpawn, bool playerRoom)
{
    roomDataLocation_ = "./Resources/Map/Room/Factory_Room_9x9_01.csv";
    position_ = position;
    roomWidth_ = 9;
    roomHeight_ = 9;
