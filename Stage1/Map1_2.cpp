...
void Map1_2::GenerateRandomRoomPlacement()
{
...
void Map1_2::CreateRoom(sf::Vector2i position, bool left, bool right, bool up, bool down)
{
...
void Map1_2::CreateEmptyRoom(sf::Vector2i position)
{
    for (int y2 = position.y; y2 < position.y + 10; y2++)
    {
        for (int x2 = position.x; x2 < position.x + 10; x2++)
...
void Map1_2::CreateLeftHall(sf::Vector2i position)
{
...
void Map1_2::CreateRightHall(sf::Vector2i position)
{
...
void Map1_2::CreateUpHall(sf::Vector2i position)
{
...
void Map1_2::CreateDownHall(sf::Vector2i position)
{
...
void Map1_2::PlacePlayer(sf::Vector2i position)
{
...
void Map1_2::PlaceEnemy(sf::Vector2i position)
{
    for (int y = position.y; y < position.y + 10; y++)
    {
        for (int x = position.x; x < position.x + 10; x++)
...
void Map1_2::PlaceStaircase(sf::Vector2i position)
{
    int saftyNet = 0;
    while (saftyNet < 100)
    {
        ...
        {
            map_[x][y] = 40;
            objectMap_[x][y] = transitionManager_->GetSceneID("Stage1_3");
...
void Map1_2::PlaceJunkYard(sf::Vector2i position)
{
    int saftyNet = 0;
    while (saftyNet < 100)
    {
