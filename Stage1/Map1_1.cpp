...
void Map1_1::GenerateRandomRoomPlacement()
{
...
void Map1_1::CreateRoom(sf::Vector2i position, bool left, bool right, bool up, bool down)
{
...
void Map1_1::CreateEmptyRoom(sf::Vector2i position)
{
    for (int y2 = position.y; y2 < position.y + 10; y2++)
    {
        for (int x2 = position.x; x2 < position.x + 10; x2++)
...
void Map1_1::CreateLeftHall(sf::Vector2i position)
{
...
void Map1_1::CreateRightHall(sf::Vector2i position)
{
...
void Map1_1::CreateUpHall(sf::Vector2i position)
{
...
void Map1_1::CreateDownHall(sf::Vector2i position)
{
...
void Map1_1::PlacePlayer(sf::Vector2i position)
{
...
void Map1_1::PlaceEnemy(sf::Vector2i position)
{
    for (int y = position.y; y < position.y + 10; y++)
    {
        for (int x = position.x; x < position.x + 10; x++)
...
void Map1_1::PlaceStaircase(sf::Vector2i position)
{
    int saftyNet = 0;
    while (saftyNet < 100)
    {
...
void Map1_1::PlaceJunkYard(sf::Vector2i position)
{
    int saftyNet = 0;
    while (saftyNet < 100)
    {
