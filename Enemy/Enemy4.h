...
{
public:
    Enemy4(sf::Vector2f position, Scene *scene, LocalEnemyManager* lem, PlayerManager* playerManager, ParticleManager* pm, Map* map);
    ~Enemy4() override;
...
private:
    ...
    sf::Vector2f DFS(sf::Vector2f location, std::vector<sf::Vector2f> visited, sf::Vector2f end);
